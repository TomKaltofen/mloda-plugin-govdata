...
- **Add a dataset here**: see [docs/adding-a-reader.md](docs/adding-a-reader.md). Every reader is a thin subclass of `BaseGovDataReader` that overrides the parse step (and the fetch step for a non-GovData source).
